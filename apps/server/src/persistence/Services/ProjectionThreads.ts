...
export const ProjectionThread = Schema.Struct({
  ...
  mutedAt: Schema.NullOr(IsoDateTime),
  prNumber: Schema.NullOr(PositiveInt),
  prTitle: Schema.NullOr(Schema.String),
  prUrl: Schema.NullOr(Schema.String),
  prState: Schema.NullOr(OrchestrationThreadPrState),
  prBaseBranch: Schema.NullOr(Schema.String),
  prHeadBranch: Schema.NullOr(Schema.String),
  prBranch: Schema.NullOr(Schema.String),
  prRefreshedAt: Schema.NullOr(IsoDateTime),
